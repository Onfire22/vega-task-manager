...
const makeSeed = async () => {
	await prisma.dictionary.createMany({
		data: [
			...
			{ type: 'USER_SPECIALISATION', label: 'Frontend разработчик', key: 'fe-dev' },
			{ type: 'USER_SPECIALISATION', label: 'Backend разработчик', key: 'be-dev' },
			{ type: 'USER_SPECIALISATION', label: 'Fullstack разработчик', key: 'fs-dev' },
			{ type: 'USER_SPECIALISATION', label: 'Тестировщик', key: 'qa-dev' },
			{ type: 'USER_SPECIALISATION', label: 'Аналитик', key: 'ba-dev' },
